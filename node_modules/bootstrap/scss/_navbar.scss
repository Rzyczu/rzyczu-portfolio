...
.navbar-nav {
  ...
  // --#{$prefix}nav-link-active-font-size: #{$nav-link-active-font-size};
  --#{$prefix}nav-link-active-font-weight: #{$nav-link-active-font-weight};
  ...
  .nav-link.active {
    ...
    // font-size: $nav-link-active-font-size;
